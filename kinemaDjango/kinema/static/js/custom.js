    ...
    "use strict";
        ...
        //5. Datepicker init
                    ...
                    $('.time-select__item').click(function (){
                        ...
                        var chooseCinema = $('.time-select__place').attr('data-cinema');
                        var chooseDate = $('.datepicker__input').val();
                         $('.choose-indector--time').find('.choosen-area').text(chooseTime + " " + chooseDate + " " + chooseCinema);

                        //data element set
                        $(".choosen-date").attr("value", chooseDate);
                        $(".choosen-cinema").attr("value", chooseCinema);
                        $(".choosen-time").attr("value", chooseTime);
                    });
                    var chooseDate = $('.datepicker__input').val();
...
function init_BookingTwo () {
    ...
    //3. Choose sits (and count price for them)
                ...
                $('.sits__place').click(function (e) {
                    ...
                    //data element set
                    numberTicket.attr("value", number);
                    sumTicket.attr("value", sum);
                    cheapTicket.attr("value", cheap);
                    middleTicket.attr("value", middle);
                    expansiveTicket.attr("value", expansive);
                    ...
                    //data element set
                    var mid = Math.ceil(chooseSits.length / 2);
                    chooseSits = chooseSits.slice(0,mid);
                    sits.attr("value", chooseSits);
                });
